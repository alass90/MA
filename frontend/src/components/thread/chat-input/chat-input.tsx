    ...
    const renderTextArea = useMemo(() => (
      <div className="flex flex-col gap-1 px-2">
        <Textarea
          ...
          className={cn(
            'chat-input-textarea w-full bg-transparent dark:bg-transparent border-none shadow-none focus-visible:ring-0 px-0.5 pb-6 pt-4 !text-[15px] min-h-[100px] sm:min-h-[72px] max-h-[200px] overflow-y-auto resize-none',
