...
export const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      '1 concurrent run',
      '10 Total Chats',
      'Basic Mode - Core Talos experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create Talos Agents with custom Knowledge, Tools & Integrations',
      ...
      'Talos Power mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create Talos Agents with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create Talos Agents with custom Knowledge, Tools & Integrations',
