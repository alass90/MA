...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Talos',
    description: 'Replay this Agent conversation on Talos',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Talos';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Talos';
