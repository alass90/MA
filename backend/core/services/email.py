...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'hey@talos.com')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Talos Team')
        self.hello_email = 'hello@talos.com'
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Talos — Let's Get Started "
    ...
    def send_referral_email(
        ...
        try:
            ...
            mail = mt.Mail(
                sender=mt.Address(email=sender_email_to_use, name='Talos'),
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="Talos Logo" class="logo">
    </div>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to <a href="https://www.talos.com/">Talos.com</a> — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Talos community!</p>
  </div>
</body>
</html>"""
...
Welcome to https://www.talos.com/ — we're excited to have you on board!
...
Thanks again, and welcome to the Talos community!

---
© 2025 Talos. All rights reserved.
You received this email because you signed up for a Talos account."""
  ...
  <tr>
    <td>
      ...
      <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6;">
        <strong>{sender_name}</strong> has invited you to join Talos using a personal referral code.
    ...
    <tr>
      <td>
        <div style="text-align: center; margin-bottom: 40px;">
          <img src="https://talos.com/Logomark.svg" alt="Talos" style="height: 24px; width: auto; display: inline-block;" />
        </div>
        ...
        <div style="text-align: center; margin-top: 32px;">
          <p style="font-size: 12px; color: #999; margin: 0;">
            &copy; Talos AI Corp. All rights reserved.
          </p>
        </div>
      </td>
    </tr>
...
{sender_name} has invited you to join Talos using a personal referral code.
...
---
© Talos AI Corp. All rights reserved."""
