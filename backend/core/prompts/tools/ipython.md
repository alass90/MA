...
- **File System**: 
  - `/tls/Talos/upload` (read-only user files)
  - `/tls/Talos/output` (write deliverables)
...
- **Step Budget**: Counts as 1 tool call against 10-step (Base) or unlimited (Talos Computer) limit
