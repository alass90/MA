...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_talos_team:
            metadata['is_talos_team'] = True
            metadata['talos_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_talos_team: {template.is_talos_team}")
        return agent_id
