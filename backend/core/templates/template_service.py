...
class TalosDefaultAgentTemplateError(Exception):
    pass
...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_talos_default_agent(agent):
            raise TalosDefaultAgentTemplateError("Cannot create template from Talos default agent")
    ...
    async def get_public_templates(
        self,
        is_talos_team: Optional[bool] = None,
        ...
        if is_talos_team is not None:
            query = query.eq('is_talos_team', is_talos_team)
    ...
    def _is_talos_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_talos_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_talos_team=data.get('is_talos_team', False),
