...
TALOS_HELLO_EMAIL = 'hello@talos.com'
...
class NotificationService:
    ...
    async def send_task_completion_notification(
        ...
        try:
            ...
            task_url = f"https://www.talos.com/projects/{project_id}/thread/{thread_id}" if project_id else f"https://www.talos.com/thread/{thread_id}"
