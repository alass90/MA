...
2. Build a custom image:
   ...
   docker push talos/talos:0.1.3.25
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `talos/talos:___`)
...
3. Push the new version: `docker push talos/talos:0.1.3`
